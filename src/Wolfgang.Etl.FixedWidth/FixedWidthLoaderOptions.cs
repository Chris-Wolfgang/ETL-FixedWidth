...
/// <summary>
/// Options for the <see cref="System.IO.Stream"/>-based <see cref="FixedWidthLoader{TRecord}"/>
/// constructors.
/// </summary>
/// <remarks>
...
/// <see cref="System.IO.TextWriter"/> constructors take no options today, and would take their own
...
public sealed record FixedWidthLoaderOptions
{
    ...
    /// </summary>
    /// <remarks>
    /// A <see cref="System.IO.TextWriter"/> already carries its own encoding, which is why encoding is
